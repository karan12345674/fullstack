            ...
            <tr>
              ...
              <th className="p-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    onClick={async () => {
                      if (contacts.length === 0) return toast.error("⚠ कोई contacts नहीं मिले!");
                      toast(
                        (t) => (
                          <div className="flex flex-col gap-2">
                            <span>क्या आप सभी contacts को delete करना चाहते हैं?</span>
                            <div className="flex gap-2 justify-end">
                              <button
                                className="bg-red-600 text-white px-3 py-1 rounded"
                                onClick={async () => {
                                  try {
                                    ...
                                    setContacts([]);
                                    toast.success("सभी contacts delete हो गए!");
                                    toast.dismiss(t.id);
                                  } catch (err) {
                    ...
                    // className="bg-red-600 text-white hover:bg-red-700 ml-2 px-2 py-1 text-sm"
                  >
